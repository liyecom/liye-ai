...
**Objective**: Prove 0 writes when kill switch OFF (风险必须反复证明)
...
## Future Auto Expansion Criteria (准入门槛模板)
...
|------------|--------|----------|
| Kill switch OFF = 0 writes | ✅ Verified (再验证) | status=SUGGEST_ONLY, notes="disabled globally" |
