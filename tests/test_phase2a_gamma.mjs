...
test('DoD#10: d11_rolling_30d_v1 is registered in validate-contracts schemaFiles; gate count == 20', () => {
  ...
  assert.match(out.stdout, /Passed:\s*20/, `expected gate count 20 (19->20 carve-out); got:\n${out.stdout}`);
});
