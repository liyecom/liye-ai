...
### 修正案 1：主线版本政策 (2026-01-01)

> **背景**：RC（Release Candidate）版本应当冻结在 tag 或 release 分支上，main 分支必须保持滚动开发状态。
...
- 适用于：main 分支的 push 和 PR 合并
- 不适用于：feature、release、hotfix 分支
